  ...
  return (
    <header className="pg-header" role="banner">
      <div className="pg-header-brand">
        <a href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 'var(--vhyx-space-2)' }}>
          <span className="pg-header-title">VhyxUI</span>
          <Badge variant="outline" size="sm">Playground</Badge>
        </a>
        <Separator orientation="vertical" style={{ height: '1.25rem', margin: '0 var(--vhyx-space-1)' }} />
        <Badge variant="info" size="sm">Four layers. One library.</Badge>
      </div>

      <div className="pg-header-actions">
        <a
          href="https://docs.vhyxui.dev"
