        ...
        <section id="v0-1-0-alpha-1" className="gs-section">
          <div className="cl-release-header">
            ...
            <div className="cl-release-meta">
              <time dateTime="2026-05-29" className="cl-release-date">
                May 29, 2026
              </time>
          ...
          <p className="gs-body">
            First public alpha release of VhyxUI. All 22 Tier 1 components are
            implemented, tested, and documented. The token system, accessibility
            layer, motion system, and VhyxSeal agent contracts all ship
            together.
          </p>
          ...
          <ul className="cl-feature-list">
            <li>
              ...
              Primitives, semantic layer, dark mode, reset, and motion
              keyframes. Zero JavaScript. No build step.
            </li>
            <li>
              <strong>@vhyxui/core</strong> — Shared TypeScript types, VhyxSeal
              default contracts for all 22 components, Slot implementation for
              the asChild pattern, and VhyxUIError error class.
            </li>
            <li>
              <strong>@vhyxui/react</strong> — All 22 Tier 1 components with
              full prop APIs, accessibility (WCAG 2.1 AA), motion, and VhyxSeal
              contracts. Dual CJS / ESM build. Tree-shakeable per-component
              imports.
            </li>
            <li>
            ...
            <li>
              <strong>toast() imperative API</strong> — Call{" "}
              <code>toast()</code>, <code>toast.success()</code>,{" "}
              <code>toast.danger()</code> from anywhere without props or context
              wiring.
            </li>
            <li>
            ...
            <li>
              ...
              default VhyxSeal contract readable via{" "}
              <code>data-vhyx-contract</code>. Destructive Button variant
              auto-upgrades to <code>safetyLevel: critical</code>.
            </li>
            <li>
          ...
          <div className="cl-alpha-notice">
            <strong>Alpha notice.</strong> This is a pre-release. APIs are
            stable but not semver-frozen until v0.1.0. Minor breaking changes
            may occur between alpha versions. Pin your version and check this
            changelog before upgrading.
          </div>
        </section>

        <PageNav prev={{ title: "Token Reference", href: "/docs/tokens" }} />
      </main>
